...
kubectl delete namespace spring-enterprise
...
kubectl create configmap auth-server-configmap --from-file=src/main/resources/application.yml -o yaml --dry-run | kubectl apply -f -
